languages = {
	"ru": {
		...
		"already_enabled": "Указаные модуль уже включен.",
	...
	"en": {
		...
		"no_perms": "You don't have permissions to invoke this command.\n",
		...
		"prefix_changed": "Command prefix for this server set to `{}`.",
		"scanner_already_running": "Wait for the scan finish or cancel it.",
		"invalid_limit": "Message count must be in 1 to 100 range.",
		...
		"diffcnotify_notset": "Notifications channel is not set on this server yet.",
